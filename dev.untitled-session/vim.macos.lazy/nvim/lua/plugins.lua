...
-- or                              , branch = '0.1.x',
      ...
      config = function()
        ...
        s("n", "<space>f", "<cmd>Telescope find_files<CR>", { desc = "fuzzy files find" })
      end
  },
  ...
  -- MY
  {
    '1llusion1st/nvim-markdown-runner',
    config = function()
      vim.keymap.set( "n", "<space>h", ":MarkdownRunnerInsert<CR>", {})
    end
  },
  ...
  -- AI
  {
    'https://github.com/Robitx/gp.nvim',
     ...
     config = function() 
        ...
        local key_file = os.getenv("OPENAI_FILE")
        local key = readAll(key_file)
        
        require("gp").setup( { openai_api_key = key })
     end
  },
