...
plugins=(git aws zsh-autosuggestions zsh-syntax-highlighting web-search docker docker-compose tmux golang )
...
export PATH=/usr/local/texlive/2021basic/bin/universal-darwin/:/usr/local/gcc-10.1.0/bin:$PATH:~/go/bin
...
export PATH="$PATH:/Users/andrew/development/flutter/bin"
...
export PATH="$PATH:/usr/local/Cellar/openvpn/2.6.6/sbin/:/Users/andrew/work/av/tools/bin/"
