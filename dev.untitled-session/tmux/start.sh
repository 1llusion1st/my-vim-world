...
source $DEV_DIR/../projects.source
...
tmux new-session -d -s $SESSION_NAME -x "$(tput cols)" -y "$(tput lines)" -n main \; send-keys "source $DEV_DIR/../projects.source ; $DEV_DIR/opt/nvim/bin/nvim -u $DEV_DIR/vim/init.vim TODO.md" C-m ;
